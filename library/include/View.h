...
private:
    ...
    virtual void displayBoard(BoardPtr &board, PlayerPtr &player1, PlayerPtr &player2) const = 0;
    virtual void displayCapturedPieces(PlayerPtr &player1, PlayerPtr &player2) const = 0;
    virtual void displayEndGameMenu() const = 0;
public:
    View();
    virtual ~View();
    virtual void displayDefView(BoardPtr &board, PlayerPtr &player1, PlayerPtr &player2) = 0;
    virtual bool readIfNewGame() const = 0;
    virtual bool readUserChoice() const = 0;
    virtual void displayWinner(PlayerPtr winner) const = 0;
    virtual void displayDraw() const = 0;
    virtual Color readUserChoiceOfColor() const = 0;
